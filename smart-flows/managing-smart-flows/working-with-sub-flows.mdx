...
*   Click on**New Flow**![](./Working with Sub Flows – Salesmate_files/mceclip1.png)


*   Select the flow type as**Sub Flow**![](./Working with Sub Flows – Salesmate_files/mceclip1(1).png)
