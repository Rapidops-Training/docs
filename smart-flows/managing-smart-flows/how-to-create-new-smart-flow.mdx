...
<Note>**Note:** A User with Manage Flow rights can perform this operation</Note>
...
- When you select Trigger Based flow you would get an option to**Select a Flow Trigger.**![](./How to Create New Smart Flow – Salesmate_files/mceclip3.png)
