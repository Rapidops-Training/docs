...
####**Topic Covered:***   [Business Type](https://support.salesmate.io/hc/en-us/articles/42405775461785-Send-an-Email-after-First-Purchase#h_01JHZKVPKJSQNNNM12WR3TSWPT)
...
####**Key Features of the Flow**1.**Automated Shipping Confirmation**The flow sends an automated, personalized email to customers with detailed shipping information, including tracking details and estimated delivery times.


2.**Feedback Request Email**After the estimated delivery date, the flow triggers a follow-up email, requesting customer feedback on the product and service received, along with a CTA to leave a review or fill out a survey.


3.**Customer Engagement & Trust Building**By keeping customers informed and asking for feedback, this flow fosters trust and builds stronger customer relationships, contributing to higher satisfaction and loyalty.


4.**Email Automation**Automates the sending of two essential emails—Shipping Confirmation and Feedback Request—saving time and improving communication consistency.
...
![Screen Shot 2025-01-19 at 9.28.37 PM.png](./Send an Email after First Purchase – Salesmate_files/Screen Shot 2025-01-19 at 9.28.37 PM.png)
