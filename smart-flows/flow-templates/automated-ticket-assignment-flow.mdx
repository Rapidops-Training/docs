...
[Business Type](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#h_01JHZXBCYX17AQAT4KGKAFC6M4)[Template Type](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#01JHZXFD9EJGR7QCB6A5RHB5HZ)[Use Case](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#01JHZXFD9EJGR7QCB6A5RHB5HZ)[Key Features of the Flow](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#01JHZXHG6TY8S1SZ57BH3G6T6D)[Steps Used In Creating the Flow](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#01JHZXKFC4KFBWW67SWPPWDHT9)[Break Up of Items Used in the Flow](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#h_01JHT979E2NZ3VK5JH7FTYRVYV)[Benefits](https://support.salesmate.io/hc/en-us/articles/42347418669209-Automated-Ticket-Assignment-Flow#01JHZZ28ER74CF0A7KG6N1M32Z)
...
### Flow Process Breakdown**Trigger**:**[Form Submission](https://support.salesmate.io/hc/en-us/articles/37775479211289-Form-Submitted)****Description:**The flow is triggered when a form is submitted, indicating the creation of a new support ticket. This initial step captures all relevant form data and prepares it for processing.**Practical Use Case:**For example, when a customer fills out a support form, the flow is initiated to process the information and create a ticket automatically.

![mceclip0.png](./images/mceclip0-2.png)

**Action 1: [Record Create](https://support.salesmate.io/hc/en-us/articles/36763966875289-Record-Created) (Ticket)****Description:**The flow creates a new ticket using the data from the submitted form. This ensures that a formal ticket record is created in the system for tracking and resolution.**Practical Use Case:**A customer submits a support form reporting a login issue. The workflow**automatically creates a ticket**, ensuring the issue is logged and assigned for resolution without manual intervention.

![mceclip1.png](./images/mceclip1-2.png)

**Condition: [Branch](https://support.salesmate.io/hc/en-us/articles/37780627045657-Branch) (Priority Categories)****Description:**The ticket is evaluated based on the data, such as priority or urgency, and is divided into one of three categories:**Low**,**Medium**, or**High**priority.**Practical Use Case:**For instance, urgent tickets related to critical system issues are categorized as**High**, while less time-sensitive inquiries are categorized as**Low**.
...
**Action 3: [Update Record](https://support.salesmate.io/hc/en-us/articles/38138030465817-Update-Record)****Description:**As the flow progresses, the system automatically updates the ticket’s ownership, status, priority, team assignments, and any other relevant fields.**Practical Use Case:**For example, once a ticket is assigned to a team, the**ownership**field is updated along with other parameters, ensuring the agent or team is responsible for resolving the issue.
