...
<Note>**Note:**You’ll need permission to manage Smart Flows to set up this trigger.
...
***Email Address**:
    *   You’ll get a custom email address like SF-ER-\[yourtext\]@yourdomain.salesmate.io.
    *   The “SF-ER” part is fixed, but you can pick a custom word (3-20 characters, using letters, numbers, hyphens, or dots).
...
***Send a Test Email**:
    *   Send an email to your parser address. You can copy the address from the screen.
    *   The system saves the last 3 non-test emails, listed from newest to oldest.
