...
![](./Deal Status Match – Salesmate_files/mceclip0.png)
...
*   As you click on the block, a pop will open to add following details.
    ...
    ***Status:**Select the specific deal status that, when updated to this status, will trigger the flow.

*   Once selected, hit**Save.****![](./Deal Status Match – Salesmate_files/mceclip1.png)**### [Practical Example](https://support.salesmate.io/hc/en-us/articles/36768404490393-Deal-Status-Match#h_01J7WR44Y96G5FT52Y14QX6G1V)
...
![](./Deal Status Match – Salesmate_files/mceclip0(1).png)
