...
- Navigate to the preferred **Module** from the left menubar **(Contacts, Companies & Custom Modules)**
- Search for the contacts that you wish to merge. You can merge a maximum of 3 records at a time. 
