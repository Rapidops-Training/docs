...
description: "Calculated fields allow you to perform automatic calculations based on existing data from other fields or related modules."
---
...
![](./How to create Calculated Fields – Salesmate_files/mceclip1.png)
...
![](./How to create Calculated Fields – Salesmate_files/mceclip0.png)
...
*   Click on the**Add New Field**![](./How to create Calculated Fields – Salesmate_files/mceclip1(1).png)


*   Select the Calculated Field or search the Calculated Field with the Quick Search option

![](./How to create Calculated Fields – Salesmate_files/mceclip1(2).png)
...
![](./How to create Calculated Fields – Salesmate_files/mceclip2.png)
