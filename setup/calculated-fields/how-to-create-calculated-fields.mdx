...
- **Select Operation:**Select the operation to be performed on the values of the chosen field.For **Number Type,**the available operations are:**COUNT**: Counts all values.
...
- **MAX:** Finds the maximum value.For **Date Type**,- **MIN:** Finds the minimum value.
