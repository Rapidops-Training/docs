...
description: "Salesmate Seats give you the flexibility to manage different types of users in your account without unnecessary costs."
---

Salesmate Seats give you the flexibility to manage different types of users in your account without unnecessary costs.
...
*   Gives full access to all Salesmate features and operations.

*   Assigned by default whenever a new user is created.
...
![](./Salesmate Seats – Salesmate_files/mceclip1.png)


### Salesmate Seats can be used for:


*   Giving Core Seats to team members who need full access to Salesmate to manage the core features like records, Reports and automations.
