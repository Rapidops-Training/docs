...
description: "A**User**is the one who manages records within the organization, whether their own or those shared by other _users_."
---
...
*   [**How to Edit the User details?**](https://support.salesmate.io/hc/en-us/articles/19297433873177-Managing-Users-in-Salesmate#h_01H2AD3WDB3WVBDQM1BV11R3CV)

*   [**How to Deactivate the User?**](https://support.salesmate.io/hc/en-us/articles/19297433873177-Managing-Users-in-Salesmate#h_01H2AD42PPJ8H0MJ8KP3PMPJMJ)
...
*   Click on**Set-Up***   Head over to the**Users & Security**category

*   Select**Users**![](./Managing Users in Salesmate – Salesmate_files/mceclip0.png)


*   Click on**New**![](./Managing Users in Salesmate – Salesmate_files/mceclip2.png)


*   Add the User details and click on**Save**####**User Fields:*****First Name (Required):**The user's first name
...
***[Profile (Required)](https://support.salesmate.io/hc/en-us/articles/19326369490457):**Determines the permission level or access control set for the user (e.g., "Admin").

*   [Role (Required):](https://support.salesmate.io/hc/en-us/articles/19328651153689) The functional role or designation in the organization (e.g., "CEO").
...
***Other fields:*****Phone:**Additional phone field
...
![](./Managing Users in Salesmate – Salesmate_files/mceclip3.png)
...
*   Click on the**Actions**Button and select**Edit**![](./Managing Users in Salesmate – Salesmate_files/mceclip5.png)


*   Here you can Edit any details and click on Update.

![](./Managing Users in Salesmate – Salesmate_files/blobid0.png)
...
*   Select**Deactivate**![](./Managing Users in Salesmate – Salesmate_files/mceclip7.png)


*   The User deactivation can be done with two options,
    ***Deactivate this User and release the license*****Deactivate this User and invite a new user using the same license**![](./Managing Users in Salesmate – Salesmate_files/mceclip8.png)
...
![](./Managing Users in Salesmate – Salesmate_files/mceclip9.png)
