...
---
A **Seat** refers to the type of user license assigned to a person in your account. Each active user in your account is assigned a seat, and the type of seat determines what access that user has.You can assign a seat while adding a new user or changing the seat for an existing user.
...
- **Head over to the **Users & Security** category.Select ** Users.***![mceclip0.png](./images/mceclip0-2.png)
...
Choose the type of seat you want to assign:**AI Agents (Skara)**: AI solution powered by conversational agents and insights to boost your sales and support teams.
...
- **Head over to the **Users & Security** category.Select **Users** or **Seats.
