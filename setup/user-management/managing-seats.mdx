...
- Choose the type of seat you want to assign:
  ...
  - **Skara**: The complete CRM solution for all your business needs.
    - **Core**: Full access to all Skara features. This is a paid seat and does not include AI Agents (Skara).
