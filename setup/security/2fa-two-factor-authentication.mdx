...
- **_Two-factor authentication (2FA)_**_,_ sometimes referred to as two-step verification or dual-factor authentication is an extra layer of security used to make sure that people trying to gain access to an online account are who they say they are. 
...
- Enter the code from the app below. Once connected, we will remember your phone so you can use it each time you log in.
...
-  Head over to the "**Security**" option in the sidebar
- Click on the "**Two Factor Authentication**" section
- Enter the**Salesmate Account Password**  and click on **Unlock Settings**
...
Click on \*\* Yes \*\*<img src="./images/mceclip6.png" alt="mceclip6.png" />
