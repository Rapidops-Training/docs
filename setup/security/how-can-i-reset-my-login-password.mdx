...
You can reset your **Skara** password by following the below-mentioned steps :
...
- In the new screen enter your **New password** and confirm by clicking on the Set **Password option**.
- This will reset your password.

![mceclip6.png](./images/mceclip6-2.png)

Use the email address and the new password to log in to your Skara account.