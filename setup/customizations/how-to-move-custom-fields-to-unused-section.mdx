...
**Inactive Fields** have been renamed to **Unused Fields** in Skara. Unused Fields are essentially fields that are not needed in the Module Create Form and are moved to the Unused Field Section for organization.
