...
Click the **"Add Dependency Field"** button to begin mapping the dependency between fields.To create a field dependency, you need at least two select or multi-select fields.A popup will appear with two options:**Parent Field:** Select the parent field from the dropdown. Only one value can be selected **(Eg: Membership Type)**<img src="./images/mceclip11-6.png" alt="mceclip1(1).png" />
