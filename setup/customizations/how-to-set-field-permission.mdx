...
*   Select the Module(**Contact, Company, Deal, Products, and Custom Modules)**

![](./How to Set Field Permission – Salesmate_files/mceclip1.png)
...
![](./How to Set Field Permission – Salesmate_files/mceclip2(1).png)
<Note>
