...
<Note>
  **Note:** 
  ...
  - Lookup fields are only available for the Contact, Company and Ticket modules.
  - You can create Lookup fields of the type Contact, Company, Ticket modules, and Users.
