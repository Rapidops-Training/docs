...
description: "Custom Fields are the most powerful way of capturing information in a successful organization-specific CRM system."
---
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/GQ7WC3_h-EE?list=PLyYol_VsdQ5kq3RxvfA2NaXeI_5bAaF1x"
  title="YouTube video"
  frameborder="0"
...
Go to**Customize the Module Create Form**Click on the**Add New Field**
...
Provide the following details**Field****Label:**Define the label to identify the field**Internal Name:**Define the internal name for API integrations**Section:**Select the Section you wish the Field to fall under.**Help Text:**Define Help Text to provide additional information to help your teammates understand the purpose of the field

![mceclip4.png](./images/mceclip4-4.png)

After adding details to a custom field, you can select the following options:**Appear in Quick Creation Form:**Display this field in the quick creation form for easy access.**Appear in Global Search Results:**Allow searching on this field when a user performs a global search.**Do not allow Duplicate Values:**Prevent the creation of duplicate records based on this field.**Always Required:**Make this field mandatory if needed.Once done, Click**Save.****
