...
---
Salesmate comes preloaded with basic activity types viz.

- **Call, Task, Meeting, Demo**. You can create your **own activity types** and assign an **icon** to them.Activity Types will be listed based on the order defined in the Activity Type Menu. You can activate or deactivate an activity type. However, they cannot be deleted.

- **To create a new activity type:**Navigate to the **Profile icon** in the top right corner.Click on **Setup.

- **Head over **Modules category** Click on ** Activity Module ***![mceclip0.png](./images/mceclip0-15.png)
