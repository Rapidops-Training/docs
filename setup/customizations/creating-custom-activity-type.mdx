...
Salesmate comes preloaded with basic activity types viz.**Call, Task, Meeting, Demo**. You can create your**own activity types**and assign an**icon**to them.

Activity Types will be listed based on the order defined in the Activity Type Menu. You can activate or deactivate an activity type. However, they cannot be deleted.**To create a new activity type:***   Navigate to the**Profile icon**in the top right corner.

*   Click on**Setup.***   Head over**Modules category***   Click on**Activity Module****![](./Creating Custom Activity Type – Salesmate_files/mceclip0.png)***   Head to the Type Section

*   All your activity types are listed on this screen.

*   Click the**\+ Activity Type**option to add a new activity type.

![](./Creating Custom Activity Type – Salesmate_files/mceclip3.png)


*   Select the**Icon**for the Activity Type**.***   Enter the**Name**of the new Activity Type.
...
![](./Creating Custom Activity Type – Salesmate_files/mceclip4.png)
