...
Navigate to the **Profile Icon** at the top right corner.Click on **Setup**. Go to the **Modules** section.Select the Module on which you wish to create a Validation RuleHere, click on the ** Validation Rules ***![Screen Shot 2025-02-18 at 10.26.01 AM.png](./images/Screen-Shot-2025-02-18-at-10.26.01-AM-2.png)
