...
- ** Click on **Setup**. Click on **Modules** and choose the module where you want to modify the validation rule.
...
Click **Update** to save changes while keeping the rule in draft mode.Click **Publish** to activate the rule.
