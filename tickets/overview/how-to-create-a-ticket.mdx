...
* A Quick Create Form will appear, you can choose to create a Ticket with
essential fields only 

<img src="images/007-quick-create-ticket-form-26023658046361.png" alt="Quick create ticket form" />
* Or expand the form to create a detailed ticket and enter the details * You
will have to choose the **Ticket Type / Pipeline** for which you want to create
a ticket. * Select the Stage * By default, the logged-in user is selected in the
- *Owner** field, you can change the owner if required * The default **Priority**
of the ticket is none, but it is mandatory to choose a value. * You can
associate a **Contact, Company, or Product** with the Ticket * Once done, click
on **Save**.
