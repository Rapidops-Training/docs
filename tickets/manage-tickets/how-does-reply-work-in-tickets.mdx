...
* Click on the Ticket to open it in the Detail View * Then, navigate to the
- *Reply** option and type your response using the text editor. * You can also
include the Attachments, Images, or the Links within the Replies * Once your
reply is completed, send the response to the contact.
