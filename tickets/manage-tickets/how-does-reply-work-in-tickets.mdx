...
- Then, navigate to the \*_Reply_\* option and type your response using the text editor. You can also include the Attachments, Images, or the Links within the Replies, Once your reply is completed, send the response to the contact.

![Reply option in ticket detail view](images/031-reply-option-in-ticket-detail-view-29369413537433.png)
...
<Note>
  **Note:**
  ...
  - When a Contact Replies to a Closed Ticket, the Tickes will be reopened and the reply will get added.
