...
[How to Reply on Tickets](#how-to-reply-on-tickets) \* [How does Reply appear in Tickets](#how-does-reply-appear-in-tickets)
...
![Ticket module navigation](images/030-ticket-module-navigation-29368291858713.png)

- Click on the Ticket to open it in the Detail View \* Then, navigate to the


- _Reply_\* option and type your response using the text editor. \* You can also include the Attachments, Images, or the Links within the Replies \* Once your reply is completed, send the response to the contact.
...
![Ticket reply in timeline](images/032-ticket-reply-in-timeline-29369439885337.png)
