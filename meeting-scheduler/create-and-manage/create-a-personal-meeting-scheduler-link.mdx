...
description: "The Scheduler helps to create a dedicated space in your Calendar to interact with your customers/leads by booking a one-to-one call with you."
---
...
- [Create Meeting Link](https://support.salesmate.io/hc/en-us/articles/4405390538125#h_01HXBQ9E5RK069NWCJJNPBGRVQ)

- [Date and Time Availability](https://support.salesmate.io/hc/en-us/articles/4405390538125#h_01HXBR0NTT2B106KTVWWF5DKEB)
...
- Click on the**Meeting Scheduler\*** Head over to**Create Meeting Link**![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip0.png)
...
![Screenshot_2023-04-17_at_6.04.32_PM.png](./Create a Personal Meeting Scheduler link – Salesmate_files/Screenshot 2023-04-17 at 6.04.32 PM.png)
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip1.png)**Meeting Location:**The location field helps your customer to understand where both parties will connect at a scheduled time.
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip2.png)
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip3.png)
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip4.png)
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip5.png)
...
![Screenshot_2023-04-19_at_10.40.25_AM.png](./Create a Personal Meeting Scheduler link – Salesmate_files/Screenshot 2023-04-19 at 10.40.25 AM.png)
...
![Screenshot_2023-04-19_at_10.51.04_AM.png](./Create a Personal Meeting Scheduler link – Salesmate_files/Screenshot 2023-04-19 at 10.51.04 AM.png)
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip6.png)

**\*Date Override:**Users can add dates when their availability changes from regular weekly hours.

![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip7.png)
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip8.png)**Calendar**view Date(s) and Hours selection
...
![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip9.png)

- Select Business**Days\*** Select the Available**Time**Slots

![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip10.png)
...
**\*Minimum Notice Time**:\*_\*\*Set the minimum amount of time before a meeting that someone can book with you.
_ Eg: If you select this as 4 hours and it's 12:00 pm right now then the invitee will see the next available schedule after 4 pm

![](./Create a Personal Meeting Scheduler link – Salesmate_files/mceclip11.png)
