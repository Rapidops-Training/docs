...
- [Host and Location](#host-and-location)
...
- Head over to **Create Meeting Link**![mceclip0.png](./images/mceclip0-4.png)
...
- **Meeting Date Range:**Define the date range for which you can accept the meetings, following are the option through which you can set up the date range**Calendar Days **: If you select this option, invitees can book a call for any day in the next 30 days.
