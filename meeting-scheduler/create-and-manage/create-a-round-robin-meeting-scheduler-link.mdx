...
* Head over to**Create Meeting Link**
...
![Screenshot_2023-04-19_at_11.41.35_AM.png](./images/Screenshot-2023-04-19-at-11.41.35-AM.png)
...
![Screenshot_2023-04-19_at_11.44.47_AM.png](./images/Screenshot-2023-04-19-at-11.44.47-AM.png)
...
![Screenshot_2023-04-19_at_12.07.13_PM.png](./images/Screenshot-2023-04-19-at-12.07.13-PM.png)
...
![Screenshot_2023-04-19_at_12.08.27_PM.png](./images/Screenshot-2023-04-19-at-12.08.27-PM.png)
...
***Assign by Priority:**Here, you would need to set the priority for each user where we can assign numbers in order to set the priority preference. * Eg: User A, be on top then User B, and so on so forth. Users with the 1st position (User A) will get the activity first, then the user at 2nd or 3rd priority.

* For example, if two users are available on a particular date and time, who should get the first meeting? That's when this option comes in handy.
...
***Meeting Location:**The location field helps your customer to understand where both parties will connect at a scheduled time. ***In-Person**: It will be a blank section where the user can add the location of the meeting. You can add your unique conferences link via which invitees can join an online session or just the name of the place where the meeting would take place.
...
* **It requires you to pre-configure your Zoom application with Salesmate by clicking on** Profile Icon >

* **Setup**>**Apps & Add Ons**>**Apps**>**Zoom**>**Install**.
...
![Screenshot_2023-04-19_at_12.03.08_PM.png](./images/Screenshot-2023-04-19-at-12.03.08-PM.png)
