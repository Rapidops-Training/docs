...
description: "In Salesmate, there are**four**different**types**of**Meeting Scheduler**that you can create."
---
...
![](./Types of Meeting Scheduler – Salesmate_files/mceclip0.png)
...
*   [One-To-One](https://support.salesmate.io/hc/en-us/articles/4405390436493-Types-of-Meeting-Scheduler#h_01GBZ3AW5Q37W6NJSWWXA7V2EY)
...
![Screenshot_2023-04-17_at_5.44.46_PM.png](./Types of Meeting Scheduler – Salesmate_files/Screenshot 2023-04-17 at 5.44.46 PM.png)


#### Please select one of the below-mentioned types:


####**One-to-one Meeting:***   One-to-one virtual meetings offer you and your customers the upsides of meeting in with the setting, saving drive time, and acquiring adaptability and productivity.
...
*   To know how to create a one-to-one meeting, [click here.](https://support.salesmate.io/hc/en-us/articles/4405390538125)


####**Group Meeting:***   Allow multiple invitees to meet with you at one time same as scheduling a webinar.
...
*   To know how to create a Group meeting, [click here.](https://support.salesmate.io/hc/en-us/articles/4405390553613)


####**Team Meeting:***   Let the invitee pick a time when you and your team members are available.
...
*   To know how to create a Team meeting, [click here.](https://support.salesmate.io/hc/en-us/articles/4405390541965)


####**Round Robin Meeting:***   Create an event that cycles between multiple hosts. This option shows the individual availability of all selected users in the account. With this option, a contact can book a slot with a rep whose availability aligns best with their schedule.

*   To know how to create a Round Robin meeting, [click here.](https://support.salesmate.io/hc/en-us/articles/4405396818829)
