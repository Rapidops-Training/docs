...
![](./Understand different Availability options for a Meeting Scheduler – Salesmate_files/mceclip0.png)
...
![](./Understand different Availability options for a Meeting Scheduler – Salesmate_files/mceclip1.png)
