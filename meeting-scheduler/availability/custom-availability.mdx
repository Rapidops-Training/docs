...
- [**Update Date and Time Availability of Meeting scheduler**](#update-date-and-time-availability-of-meeting-scheduler)
...
- **45** minutes
- **60** minutes
- **Custom**  - Here you would be able to select custom time span in minutes or hours.
...
- Select the existing **schedule**  that you wish to use from the dropdown. \_ Once selected, the users will be able to see the schedule.
