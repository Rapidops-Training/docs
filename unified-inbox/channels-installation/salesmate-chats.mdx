...
<Steps>
  <Step title="To install Salesmate Chat">
    ...
    <img src="https://support.salesmate.io/hc/article_attachments/51173972938905" alt="Navigate to Account Settings" />
  ...
  <Step title="Access Chat Settings">
    ...
    <img src="https://support.salesmate.io/hc/article_attachments/51172650559129" alt="Navigate to Account Settings" />

    **or**
    1. Navigate to the Conversation Inbox icon from the left menu bar
    2. Head over to the **Inbox Settings** at the bottom left

   <img src="https://support.salesmate.io/hc/article_attachments/51173972942361" alt="Navigate to Account Settings" />
  </Step>
  ...
  <Step title="Create Salesmate Chat Channels">
    ...
    2. Head to the **Add New Channel** option
       ...
       <img src="https://support.salesmate.io/hc/article_attachments/51174003144217" alt="Configure chat widget settings" />
    3. Select **Chat** and add a channel name
    4. Click on the **Save** option
    <img src="https://support.salesmate.io/hc/article_attachments/51174003146265" alt="Configure chat widget settings" />
...
[Terms & Conditions](https://www.salesmate.io/tos/#establishing-an-account) and [Privacy Policy](https://www.salesmate.io/privacy-policy/#definitions)
    ...
    5. Once done click on **Next**
       <img src="https://support.salesmate.io/hc/article_attachments/51173972948889" alt="Create Workspace" />
...
<Steps>
  <Step title="Set Appearance of the Chats widget which will appear on your website to the visitors">
    ...
    4. **Background Pattern**: Select the background pattern from the given samples that will appear in the background of the background color you set
       ...
       <img src="https://support.salesmate.io/hc/article_attachments/26854077213721" alt="Configure chat Appearance settings" />
    ...
    8. Once done click on the **Finish** button
        <img src="https://support.salesmate.io/hc/article_attachments/26854071120153" alt="Configure chat Appearance settings" />
