...
***Matching Method:**Select from the following options, ***Fuzzy:**The system will perform a loose match, identifying similar but not necessarily identical records ***Exact:**The system will look for an exact match, where the field value must be identical.
