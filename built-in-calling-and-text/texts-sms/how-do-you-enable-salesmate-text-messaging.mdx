...
description: "To be able to send text messages out of Salesmate, you will need to enable the Salesmate Voice & Text app.[**Click Here - Follow the Article linked to..."
---

To be able to send text messages out of Salesmate, you will need to enable the Salesmate Voice & Text app.[**Click Here - Follow the Article linked to know more about the Calling Activation Process**](https://support.salesmate.io/hc/en-us/articles/360004733011)
