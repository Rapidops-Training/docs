...
description: "While trying to send a text message, hit**Schedule**to Schedule sending the messageYou can select the date and time and hit the Schedule buttonMessage..."
---
...
Communication isn’t a one-way street. To ensure you have effective two-way communication Salesmate CRM has added the conversation view to its text messages.**[Follow this Page for More Insights](https://support.salesmate.io/hc/en-us/articles/360037039112)**
