...
description: "Text Pilot is now called as **Text Messaging Service**. It helps you to send Text/MMS messages on a large scale. It provides users a mechanism where t..."
---
...
![](./Text Messaging Service – Salesmate_files/mceclip1.png)

*   Go to the **Text Messaging Services**
*   Hit **\+ Text Messaging Service**

![](./Text Messaging Service – Salesmate_files/mceclip0.png)

*   Give it a suitable **Name**

![](./Text Messaging Service – Salesmate_files/mceclip1(1).png)
...
![](./Text Messaging Service – Salesmate_files/mceclip2.png)
...
![](./Text Messaging Service – Salesmate_files/mceclip3.png)
...
*   You will get options to choose numbers from your pre-purchased list (Existing Numbers) or quickly purchase the new numbers and associate. 
    *   All the numbers purchased will be assigned to nobody
...
![](./Text Messaging Service – Salesmate_files/mceclip4.png)

*   **Buy New Numbers:** Salesmate will let you quickly buy new numbers from a particular state or area code.

![](./Text Messaging Service – Salesmate_files/mceclip5.png)
...
![](./Text Messaging Service – Salesmate_files/mceclip6.png)
...
![](./Text Messaging Service – Salesmate_files/mceclip8.png)

*   Click on the **Select Number** option and choose the **Text Messaging Service** 

![](./Text Messaging Service – Salesmate_files/mceclip7.png)