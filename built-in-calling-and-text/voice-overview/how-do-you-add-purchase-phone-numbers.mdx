...
You can assign more than one user to a number and users can make or receive calls with that number.If no number is assigned to you then make a call button is set to **![Screen_Shot_2018-06-29_at_1.48.52_AM.png](./images/Screen-Shot-2018-06-29-at-1.48.52-AM.png)
