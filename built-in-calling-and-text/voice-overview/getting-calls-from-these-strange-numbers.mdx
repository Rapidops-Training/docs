...
If you're getting inbound calls from a strange number that doesn't look like a real phone number, sometimes we don't get numbers inside Incoming Calls, and their caller ID is either unavailable or blocked.

Check to see if it's one of the numbers below.
