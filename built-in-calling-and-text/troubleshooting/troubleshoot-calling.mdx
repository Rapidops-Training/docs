...
- **) to the system.Check the following link in your Chrome browser to see if you have granted access to your microphone, sound, USB device, or MIDI device (whichever is applicable). Sound and a microphone are required.)chrome://settings/content/siteDetails?site=https%3A%2F%2F **demo.salesmate.io** My Salesmate URL is ** demo.salesmate.io.***![Screenshot_2018-10-24_at_10.52.16_PM.png](./images/Screenshot-2018-10-24-at-10.52.16-PM.png)
