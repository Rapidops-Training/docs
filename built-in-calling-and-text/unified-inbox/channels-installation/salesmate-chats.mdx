---
title: "How to Install Chats"
description: "Chats empowers you to engage seamlessly with your website and app visitors, fostering enhanced customer interactions and providing a platform to deliver superior customer service."
icon: "comments"
---

## Prerequisites

Before installing Chat, ensure you have:
...
<Steps>
  <Step title="To install Salesmate Chat">
    ...
    ![Navigate to Account Settings](images/054-navigate-to-account-settings-51173972938905.png)
  </Step>
  <Step title="Access Chat Settings">
    ...
    ![Navigate to Account Settings](images/055-navigate-to-account-settings-51172650559129.png)
    ...
    **or**
    ...
    ![Navigate to Account Settings](images/056-navigate-to-account-settings-51173972942361.png)
  </Step>
  <Step title="Create Salesmate Chat Channels">
    1. Click on **Channels**
    2. Head to the **Add New Channel** option

       ![Configure chat widget settings](images/057-configure-chat-widget-settings-51174003144217.png)
    3. Select **Chat** and add a channel name
    4. Click on the **Save** option

    ![Configure chat widget settings](images/058-configure-chat-widget-settings-51174003146265.png)
  </Step>
</Steps>
...
<Steps>
  <Step title="Create Workspace">
    ...
    3. To adhere to the compliances you would need to accept the [Terms & Conditions](https://www.salesmate.io/tos/#establishing-an-account) and [Privacy Policy](https://www.salesmate.io/privacy-policy/#definitions)
    4. Select I agree to the "Terms & Conditions" and "Privacy Policy" option once you have read it
    5. Once done click on **Next**

       ![Create Workspace](images/059-create-workspace-51173972948889.png)
  </Step>
</Steps>
...
<Steps>
  <Step title="Channel Access">
    1. Here, you can grant access to, - **Invite Everyone to Chat**: This will allow everyone with a chat license to respond to the channel’s conversations
...
<Steps>
  <Step title="Set Appearance of the Chats widget which will appear on your website to the visitors">
    ...
    4. **Background Pattern**: Select the background pattern from the given samples that will appear in the background of the background color you set
       ...
       ![Configure chat Appearance settings](images/060-configure-chat-appearance-settings-26854077213721.png)
    ...
    8. Once done click on the **Finish** button
       ...
       ![Configure chat Appearance settings](images/061-configure-chat-appearance-settings-26854071120153.png)
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Configure Team Settings" icon="users" href="/unified-inbox/sections/manage-channels/team-setup">
    Set up your team for efficient chat management
  </Card>
  <Card title="Add More Channels" icon="plus" href="/unified-inbox/sections/channels-installation/facebook-messenger">
