...
On assigning the phone number to a user the **'Make a call button'** on the top bar will get activatedOn the **Make a call** button you will find the numbers listed under **From** assigned to the respective user **![mceclip5.png](./images/mceclip5.png)
