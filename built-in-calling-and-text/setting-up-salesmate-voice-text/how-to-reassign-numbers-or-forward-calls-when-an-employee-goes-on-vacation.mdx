...
**Note:**If there is more than one user assigned to a number then the call will ring on the next available user to whom the number is assigned.**Alternate,**Users can [add/assign another user](https://support.salesmate.io/hc/en-us/articles/360004733311-How-can-I-change-my-phone-number-settings-#h_01GEEWCFHYHQHVN0W57R78Z2E1) ( their supervisor/manager/colleague ) to the number who can answer calls in their absence
