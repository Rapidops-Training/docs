...
Enable the **"Call Masking**" option for this number.Select the number you would like to mask from your list of verified number/sClick on **Save.**![mceclip3.png](./images/mceclip3-4.png)
