...
![](./Knowledge Base Article Version History – Salesmate_files/mceclip0.png)

*   Locate and click on the **article title** you want to review.
*   On the **article detail page**, click the **Actions** button.
*   Select **Version History**

**![](./Knowledge Base Article Version History – Salesmate_files/mceclip0(1).png)**
...
**![](./Knowledge Base Article Version History – Salesmate_files/mceclip1.png)** When a version is selected, the article content associated with that version will load on the canvas. You’ll also see details like:
...
![](./Knowledge Base Article Version History – Salesmate_files/mceclip2.png)
...
![](./Knowledge Base Article Version History – Salesmate_files/mceclip3.png)
