...
- **Note:** You’ll need “**Edit Articles**” permission to make any changes. Users without “**Publish**” permission can still update articles, but cannot make them live.
...
- [Steps to Edit a Knowledge Base Article](#steps-to-edit-a-knowledge-base-article)

- [Editing an Article in Draft Stage](#steps-to-edit-a-knowledge-base-article)

- [Editing an Article in Published Stage](#steps-to-edit-a-knowledge-base-article)

- [Editing Articles in Other Languages](#editing-articles-in-other-languages)
