...
In Skara, you can permanently delete a knowledge base article if it is no longer needed. This action removes the article from the system and cannot be undone, so ensure that deletion is the right choice before proceeding.
