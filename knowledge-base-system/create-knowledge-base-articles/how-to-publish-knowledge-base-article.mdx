...
- [Validations Before Publishing:](#validations-before-publishing)

- [How to Publish an Article](#how-to-publish-an-article)

- [What Happens When You Publish an Article](#what-happens-when-you-publish-an-article-1-status-dates-are-changed-status-changes-to-published)
