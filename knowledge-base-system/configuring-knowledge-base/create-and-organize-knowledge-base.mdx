...
- _\_From the Article Listing Screen \__\* Click on the **Knowledge Base Title** at the top and then select **Add New Knowledge Base**.

![](./images/mceclip2.png)

- _\_From the Setup Screen \__\* Go to \*\*Setup \*\* Click on \*\*Library \*\* Select \*\*Knowledge Base \*\* Click on the **Knowledge Base Title dropdown** and select **Add New Knowledge Base**.
