...
![](./How to Delete Category – Salesmate_files/mceclip0.png)

*   Click on the **Categories** tab

![](./How to Delete Category – Salesmate_files/mceclip1.png)

*   Select the category you want to delete, click the three-dot menu, and choose the **Delete** option.

![](./How to Delete Category – Salesmate_files/mceclip0(1).png)
