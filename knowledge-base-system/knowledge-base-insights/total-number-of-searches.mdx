...
- The **Y-axis:** Shows the number of searches and the


- **X-axis:** Shows the date. Add this report to your dashboard by clicking on the [Add widget](https://support.salesmate.io/hc/en-us/articles/360049849771-Manage-widgets-and-filters) and choosing the **system or Knowledge Base** filter on the left panel then selecting the report and clicking on the **Add to Dashboard** option.
