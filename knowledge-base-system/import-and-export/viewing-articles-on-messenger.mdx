...
####**Category Page*** To understand how to create a category, please visit [How to Create a Category](https://support.salesmate.io/hc/en-us/articles/44524557277465)
...
* Clicking on the**back arrow**will take you back to the category page * Clicking the**X**button will close the chat pop-up * Click on the**Arrows**beside the X button will resize the article opened
