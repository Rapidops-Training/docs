...
- **Instagram** Note: If only one channel exists in your account, this option won’t be shown.
...
Set how detailed Copilot’s responses should be:**Concise **– Short and to the point
