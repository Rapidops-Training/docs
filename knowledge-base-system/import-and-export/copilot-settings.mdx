...
_Copilot_ helps your support team deliver faster and more accurate responses by suggesting the best answers pulled from your articles, past conversations, and tickets — all based on the data sources you configure.
...
Choose the tone in which Copilot responds to customers:\*\*Formal \*\* _(default)_ – Professional tone
...
- **__Note: If no KB is enabled, you’ll see: “Please enable at least one knowledge base to use conversations.”__**
...
- _Note_: If no KB is enabled, you’ll see: _“Please enable at least one knowledge base to use conversations.”_
