...
* If multiple knowledge bases exist, the first one will be selected. * If a knowledge base is already configured in**Copilot settings**, it will appear here by default. * If none or multiple exist, the field will appear blank.
