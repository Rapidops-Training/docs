---
title: "Skara Chat SDKs"
---

The Skara Chat SDK for iOS and Android enables you to use [Skara Messenger](/chats/introduction-to-salesmate-chats/what-is-salesmate-chats) in your app, have conversations with your customers, and track events.

![Salesmate Chat SDKs](images/006-salesmate-chat-sdks-10203366344729.png)
...
- Skara Chats is an add-on and its pricing is based on the number of user seats you wish to add for users who will be managing chat communication. 
