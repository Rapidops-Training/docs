...
- [Enable in Skara Chat SDK](#enable-in-salesmate-chat-sdk)
- [Register Device Tokens](#register-device-tokens)
- [Handling Skara Chat Push Notifications](#handling-salesmate-chat-push-notifications)

### Create a Private Key

Using these [instructions](#enable-in-salesmate-chat-sdk), create and download a private key with APNs enabled. Note the Key ID for the next step. Alternatively, use an existing private key with APNs enabled.
...
- Enter the [Apple team ID](#create-a-private-key)
...
![Enable Push Notifications and Background Modes](https://quip.com/blob/YcQAAAL46hk/9wepshljJeXC413jSesrDQ?a=DyPlaIinld2WnJIiSsiD4aRanBuHReykCzMMgTSjEg0a)
