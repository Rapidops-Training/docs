...
[Click here to learn about navigation to Android - Installation in Salesmate.](#login-a-user)
...
- [Install Salesmate Chat SDK](#install-salesmate-chat-sdk)
- [Initialize Salesmate Chat](#initialize-salesmate-chat)
...
**Important:** If you choose this method you won’t be able to send push
 messages.
...
<img src="images/015-android-app-key-workspace-id-and-tenant-id-9809140921881.png" alt="Android App Key, Workspace Id and Tenant Id" />
...
```
<Note>
**Note:** If you don't currently implement a custom application, you’ll need
 to create one. A custom application looks like this:
</Note>
