...
We’ll show you how to send push notifications and/or push messages to your customers, with Firebase Cloud Messaging (FCM) in Skara Chat.
...
![Register App](images/010-register-app-10009307437977.png)
...
- Open your Skara Messenger settings and select ‘Installation → Android’. Then find the ‘Enable Push Notifications’ section. Here you'll be able to paste and save your Server API key.
...
> <Tip>
>   📘**Important**\> The recommendation of  **sendTokenToSkara()** is to call it on the initial launch of an app to update the fresh firebase token into Skara
> </Tip>
