...
![2ce6fe5-FCM_Setup_1.png](./Android SDK - Push Notifications (FCM) – Salesmate_files/2ce6fe5-FCM_Setup_1.png)

*   Once your project is set up, scroll down and select the ‘Cloud Messaging’’ card.

![8683d17-FCM_Setup_2.png](./Android SDK - Push Notifications (FCM) – Salesmate_files/8683d17-FCM_Setup_2.png)

*   Click on the Android icon to continue the setup.
*   Enter your app’s package name and click ‘Register App’.

![Screenshot_from_2022-08-09_16-15-43.png](./Android SDK - Push Notifications (FCM) – Salesmate_files/Screenshot from 2022-08-09 16-15-43.png)
...
![5d1b176-FCM_Setup_5.png](./Android SDK - Push Notifications (FCM) – Salesmate_files/5d1b176-FCM_Setup_5.png)
...
![](./Android SDK - Push Notifications (FCM) – Salesmate_files/b42d4db520b9d2271e43913588e058c058bc5a8f8a783b4343801b6707bf208a.png)
...
![](./Android SDK - Push Notifications (FCM) – Salesmate_files/453a1a4d857349f3f5f63193bdc2ee731d60e58e7df49e89bb25595c6119cec7.png)
...
![](./Android SDK - Push Notifications (FCM) – Salesmate_files/mceclip0.png)
