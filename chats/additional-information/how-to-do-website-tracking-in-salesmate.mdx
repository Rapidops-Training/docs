...
- Now click on **Salesmate Messenger** and enter the  **Workspace ID, AppKey, and Tenant ID **from the Messenger code. - You will get these details from your Salesmate Account. It will be available under the Chat icon, followed by the Messenger Settings and Installation.
