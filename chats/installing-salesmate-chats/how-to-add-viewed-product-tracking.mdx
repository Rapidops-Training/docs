...
- Navigate to **t\*\***emplates > pages** and scroll down to open any page and the bottom of the page, paste the below code, and then click **Save & apply all files\*\*.
...
![](./How to Add Viewed Product Tracking – Salesmate_files/mceclip0.png)
...
![](./How to Add Viewed Product Tracking – Salesmate_files/mceclip1.png)
...
```javascript
<script type="text/javascript">window.addEventListener('__SM_ANALYTICS_READY__', () => {SALESMATE.productViewed({productId: "{{product.id}}",storeId: "{{settings.store_hash}}"});});</script>
```
