...
- This method helps you to track new events which visitor/contact performs on your website. You can also add further information to this event which will be visible inside your Salesmate app. Read more about how to [track events](/chats/working-with-salesmate-chats/track-custom-events) inside Salesmate.
