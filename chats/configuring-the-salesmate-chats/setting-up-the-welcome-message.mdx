...
**Note:** Only users with [“Manage chat settings”
 permission](#a-user-can-set-a-custom-message-while-installing-chatshttpssupportsalesmateiohcen-usarticles360058369732-which-can-also-be-updated-with-the-course-of-time-as-and-when-needed-by-following-the-below-mentioned-steps) can
 access this setting.
