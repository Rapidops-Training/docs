...
<img src="https://support.salesmate.io/hc/article_attachments/31630134172697" alt="Open Chat settings" />
*   Under **Set up Chats**.
*   Click on the **Conversations** tab.
*   Enable the option **Include Bot Messages.**
*   Hit on **Update.**

<img src="https://support.salesmate.io/hc/article_attachments/31630258370713" alt="Include bot messages in chat" />