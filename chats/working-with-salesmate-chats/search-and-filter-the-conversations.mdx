...
![](./Search and Filter the conversations – Salesmate_files/mceclip0.png)

*   Then, start typing your keywords and you’ll see the option to search for the "_keyword"_. Click it or hit enter to search:  

![](./Search and Filter the conversations – Salesmate_files/mceclip1.png)
...
![](./Search and Filter the conversations – Salesmate_files/mceclip4.png)
...
![](./Search and Filter the conversations – Salesmate_files/mceclip5.png)
...
![](./Search and Filter the conversations – Salesmate_files/mceclip6.png)
...
![](./Search and Filter the conversations – Salesmate_files/mceclip8.png)
