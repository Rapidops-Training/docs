...
*
[Assigning Conversation to a User](#assigning-conversation-to-a-user)
*
[Assigning Conversation to a Team](#assigning-conversation-to-a-team)
...
**Note:** Conversations can only be assigned to the users who have a Chat
 license.
...
- Assigned conversations can only be re-assigned by the user with
- ["Manage conversation ownership" permission.](https://support.salesmate.io/hc/en-us/articles/360058438992)
