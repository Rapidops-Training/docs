...
With our new "Recent Conversations and Page Views" widgets on **Unified Inbox** and on the **Contact detail view** page, you can see the latest conversations and page views to understand or track any recent interactions.

**Recent Conversations and Page Views on Unified Inbox:**
...
- Navigate to Unified Inbox on left menu bar.

![Chat access](images/016-chat-access-19128696739865.png)

- Click on **Inbox Setting** at the bottom left.

![Chat settings](images/017-chat-settings-19128675552793.png)

- Open a **conversation**,
- On Quick bar, search for these widgets

![Recent conversations and page views](images/018-recent-conversations-and-page-views-18619496634905.png)

- Click on any conversation and it will open that conversation.

![Recent conversations](hhttps://support.salesmate.io/hc/article_attachments/18620317777817)
...
![Contact access](images/019-contact-access-18620417005337.png)
...
![Recent conversations and page views on contact detail view](images/020-recent-conversations-and-page-views-on-contact-detail-view-18620589849625.png)