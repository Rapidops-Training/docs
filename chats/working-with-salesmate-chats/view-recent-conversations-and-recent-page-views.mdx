...
<img src="images/016-chat-access-19128696739865.png" alt="Chat access" />* Click
on **Chat Setting** at the bottom left **.**

<img src="images/017-chat-settings-19128675552793.png" alt="Chat settings" />*
Open a **conversation**, * On Quick bar, search for these widgets
...
Here, on Quick Bar search for **these widgets** * Click on any conversation
available under "**Recent Conversations**" and it will open that conversation
for a quick view * You can quickly track the page visits from the "**Page View
- *" option used by your customers to reach you over
