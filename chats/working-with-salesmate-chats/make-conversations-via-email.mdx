...
- If the attachments are not allowed then the attachments are dropped from the email and a log message is placed inside the conversation, you can
- [refer to this article for attachment settings](https://support.salesmate.io/knowledge/articles/360058435732/en-us?brand_id=1467849)
...
- **Note:** He will only get an email notification if he enabled it, you can
 [refer to this article on how to enable chat
 notifications.](https://support.salesmate.io/knowledge/articles/360058878071/en-us?brand_id=1467849)
