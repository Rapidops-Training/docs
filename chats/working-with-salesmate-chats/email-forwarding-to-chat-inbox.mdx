---
title: "Email Forwarding to Unified Inbox"
---

Resolve customer’s queries by using Chat as a traditional ticketing system. When you have a company's email address for the customers to reach you via email, then you can forward all those emails to your Chat and the support agents can get back to your customers by resolving all those queries simply via Unified inbox.

### How does it work?

- First, you need to enable email forwarding on your email provider - Gmail, Outlook, or any other. Then each email that comes to your inbox is converted to a conversation inside Chat Inbox. The subject of an email query will be set as the conversation title so the agents can understand the priority of the conversation/query.
...
![Email to chat conversation](images/001-email-to-chat-conversation-4403738836877.png)
...
![View raw email](images/002-view-raw-email-4403735784973.png)

### Why use Email Forwarding?

- It is very convenient for you as it enables you to solve all the queries from one platform - Unified Inbox. Now you don't need your agents to keep a check on email support, as you can utilize those resources on Chat for resolving all problems from one place!
...
![Chat settings](images/003-chat-settings-4407062610201.jpg)

To set up Email Forwarding, simply follow the steps:

- Go to **Unified inbox** from the left menu panel
- Click on **inbox Settings** available on the footer of the chat listing column
...
<Note>
  **Notes:**
  ...
  - Any email addresses included in To or CC that are part of ignore list will be dropped, for more info refer to [Ignore internal email addresses](#resolve-customers-queries-by-using-chat-as-a-traditional-ticketing-system)
</Note>