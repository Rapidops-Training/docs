...
- Click on **Go to** **My Account**- Select **Notification Preferences**<img src="images/003-notification-preferences-31703651461017.png" alt="Notification Preferences" />
...
- You can configure your notification preferences for the following type of notifications: - **New chat conversation started**- You will be notified when a new conversation has begun, and it is not assigned to anyone yet.
...
<img src="images/004-chat-notification-preferences-19126829983897.png" alt="Chat Notification Preferences" />
...
**Note:**- Chat notification preferences are only available to users with an active messenger workspace.
