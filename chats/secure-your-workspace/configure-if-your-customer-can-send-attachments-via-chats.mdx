...
![](./Configure if your customer can send attachments via Chats – Salesmate_files/mceclip0.png)
...
![](./Configure if your customer can send attachments via Chats – Salesmate_files/mceclip0(1).png)
