...
*   Click on**Roles & Permission****![mceclip3.png](./Snippet Roles & Permissions – Salesmate_files/mceclip3.png)***   Click on Edit button of the Profile you want to edit the Permission.

![](./Snippet Roles & Permissions – Salesmate_files/mceclip0.png)


*   These snippet permissions will be displayed under the**"Snippet Permissions"**section at the bottom of the profile settings.

![Screen Shot 2024-11-29 at 9.17.12 PM.png](./Snippet Roles & Permissions – Salesmate_files/Screen Shot 2024-11-29 at 9.17.12 PM.png)

Here, you will get the list of following options


***View Permissions:*****Shared Snippets**: This permission allows users to view only the snippets that have been specifically shared with them.
...
***Edit Permissions:*****Owned Snippets**: This permission lets users edit the snippets they own. They can update or modify their own predefined text blocks but can’t make changes to others’ snippets.
...
***Delete Permissions:*****Owned Snippets**: Users with this permission can delete only the snippets they own. They cannot delete snippets created by others.
