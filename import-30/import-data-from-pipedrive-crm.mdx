...
- Select**Import Or Migrate**![](./Import data from Pipedrive CRM – Salesmate_files/mceclip0.png)

- Select**Import from other CRM**![](./Import data from Pipedrive CRM – Salesmate_files/mceclip0(1).png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip11.png)**Previous Import:\*\*\***Import Date:\*\*Gives you the status of the day the file was imported
