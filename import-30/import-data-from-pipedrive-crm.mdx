...
Not just contacts or companies, we allow you to import your **Deals, Activities, and Notes** too. Making it a quick migration for your Sales teams to get accustomed to a new system.**Supported CRMs:**
- Pipedrive
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip0.png)

- Select **Import from other CRM**

![](./Import data from Pipedrive CRM – Salesmate_files/mceclip0(1).png)

- Now on the next screen, select **Pipedrive**.

![](./Import data from Pipedrive CRM – Salesmate_files/mceclip1.png)
...
- The **API Key** should be available under
  ...
  - API [(How to find Pipedrive API Keys)](https://support.pipedrive.com/hc/en-us/articles/207344545-How-can-I-find-my-personal-API-key-)
  - Your API token - COPY

![](./Import data from Pipedrive CRM – Salesmate_files/mceclip2.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip3.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip5.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip6.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip7.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip8.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip9.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip10.png)

- Once Imported, the details of the Import will be visible for your reference under "**Details**"

![](./Import data from Pipedrive CRM – Salesmate_files/mceclip11.png)
...
![](./Import data from Pipedrive CRM – Salesmate_files/mceclip12.png)

- **Revert** the import which is available up to 48 hours after the import is completed.

![](./Import data from Pipedrive CRM – Salesmate_files/mceclip13.png)
