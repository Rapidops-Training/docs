...
- **Note:** Universal Layouts are available on all Salesmate plans that include **Email Campaign** features. Any team member with the **“Manage Campaign Templates”** permission can create, edit, and manage these layouts.

### **Topics covered:**

- [Creating a Universal Layout](#how-to-create-a-universal-layout)
- [How to Use the Pre-built Layout](#how-to-use-the-pre-built-layout)
- [How to Create a New Layout](#how-to-create-a-new-layout)
- [Actions You Can Perform on a Layout](#how-to-create-a-universal-layout)
...
Navigate to the **Universal Layout** Hit **+New.***![mceclip2.png](./images/mceclip2-2.png)

- *Select the** Blank Layout ***![mceclip4.png](./images/mceclip4.png)

- *Drag and drop the given blocks to add any related Content.
...
Once the Content is added, you can change the following details under **Settings**,** Content Area Width **Font Family **Background Colour **Background Image **Link Color **Content Area Background Color **Alignment **![mceclip8.png](./images/mceclip8.png)
...
To add a new variable, click on the **‘New’** button under the Variables tab, name it, and set its value. These variables can be reused across the layout for consistency. You can also refer to this for more information.
[Learn more](#actions-you-can-perform-on-a-layoutedit-update-or-change-the-layouts-design-and-editable-areas)

![mceclip10.png](./images/mceclip10-2.png)

Once all is done, click on **Save** Your **Layout** would now be successfully created.Once the Layout is ready, click on the **Pencil Icon** on the top right to update the **Template name.

- ** Hit **Save**

### Actions You Can Perform on a Layout:**Edit**: Update or change the layout’s design and editable areas.
