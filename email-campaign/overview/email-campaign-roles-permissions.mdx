...
- **Note:** The User with Admin rights by default would have all permissions wherein the Standard profile would have restrictions on these permissionsIn Salesmate, we are going to have the following permissions for campaign management.
