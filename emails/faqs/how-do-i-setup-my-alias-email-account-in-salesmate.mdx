...
Sign in to your**Google Account.**Go to the**Security tab.**Under "**Signing in to Google,**" select**App Passwords.**Select the app and device you want to generate the app password for.Follow the instructions to enter the**App Password.**
