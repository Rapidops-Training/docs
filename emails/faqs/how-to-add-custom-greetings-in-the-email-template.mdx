...
description: "You can add custom greetings like Good Morning or Good Night in your Emails automatically via Email Template. To create an email template:"
---
...
Add the Template**Name.****Create/Select**the folder where you would like to store this email template.Mention the**Subject**Line of the Email. You can also insert dynamic attributes to send personalized emails and Hit**Next.**Hit on Update and update the email template.
