...
You can now easily identify and segment records based on below parameters

- ** Email:**\

# of sent emails:**Filter contacts based on the total number of emails exchanged.
...
- **Example:**![mceclip1.png](./images/mceclip1-2.png)
