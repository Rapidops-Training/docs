...
- **Note:**Threads in Salesmate are displayed for your easy reference and do not mean that the emails within the thread are shared with every possible recipient. Unless an email is directly addressed to a recipient, they will not receive a copy — even if they are included in the thread.
