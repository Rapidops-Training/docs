...
- *If not read**- You will get a reminder if your sent email is not read by the customer (this feature requires email tracking to be on.)**If not replied**\- You will get a reminder if the contact hasn't replied to your email.
