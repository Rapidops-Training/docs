...
From the Contacts page, select the individual contacts you want to send an email to**OR**select all Contacts at once click the bulk select icon in the top left-hand corner of the screen.After you have selected your contacts. Click on the Email button.After you have finished writing your email**OR**used an existing template to compose an email, click Send Email.**Note:**Bulk Emails are available in All Plans. However, Schedule Emails are available in the Pro and above Plans only.**Bulk emailing includes emails sent using the following features:**Bulk EmailScheduling Bulk Emails**To send a Bulk email, follow the below steps:**Navigate to the**Contacts Module**from the left sidebarFilter Data through Custom ViewSelect contact or select all by clicking on the**checkbox**at the top
