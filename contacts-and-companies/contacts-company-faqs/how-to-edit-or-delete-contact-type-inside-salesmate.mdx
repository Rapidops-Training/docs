...
- Select the**Module (Contact, Company)**![](./How to Edit or Delete Contact Type inside Salesmate\_ – Salesmate_files/mceclip1.png)
...
![](./How to Edit or Delete Contact Type inside Salesmate\_ – Salesmate_files/mceclip0.png)

- Here you can**Rename**the Field or add new field.

- Once done, hit on**Save**.

![](./How to Edit or Delete Contact Type inside Salesmate\_ – Salesmate_files/mceclip1(1).png)
...
- Select the**Module (Contact, Company)\*\***![](./How to Edit or Delete Contact Type inside Salesmate\_ – Salesmate_files/mceclip1.png)**\* Go to the**All Detail Form Fields\*\*section.

- Search for**Type**field and hover over it,**Action**button will appear.

- Click on the**Remove**button to**Delete**the**Type**.

![](./How to Edit or Delete Contact Type inside Salesmate\_ – Salesmate_files/mceclip0(1).png)
