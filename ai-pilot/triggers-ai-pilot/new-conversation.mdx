...
Navigate to the **More Icon** from the left menu barClick on the **AI Pilots** Select the **AI Pilot** from the drop-down.Go to **Execution Flows.
...
Fill in the configuration:- **Name:** Add a name for the trigger.
...
- **Note:**If a selected channel is not installed, you will see this message:
...
"You need to activate the Unified Conversation Inbox and connect this channel to configure the trigger."If no voice number is assigned to the AI Pilot, you’ll see:
