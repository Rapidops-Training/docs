---
title: "Page Visited"
description: "The**Page Visited**trigger is used to initiate a chat flow when a contact or visitor lands on a specific web page. This trigger helps you engage users..."
---
...
[Add the Trigger](https://support.salesmate.io/hc/en-us/articles/45879978492057-Page-Visited#h_01JWB3F1AKPWKW0HV36BKVSTY5)[Configure the Page Visited Trigger](https://support.salesmate.io/hc/en-us/articles/45879978492057-Page-Visited#h_01JWB3F1AK06HCGNXHH4JDR99H)[Practical Example](https://support.salesmate.io/hc/en-us/articles/45879978492057-Page-Visited#h_01JWKQFG07M3MQ55WWE75FXHMR)
...
`utm_source``utm_medium``utm_term``utm_content``utm_campaign`**Audience (Visitor or Contact):**Define who can see the flow based on user type and behavior.Choose either:**Visitor**(default) – applies to any anonymous visitor.**Contact**– targets only identified users (logged-in or recognized).**Chat Display Behavior:**Configure when the chat flow should appear to the visitor once the conditions are met.
