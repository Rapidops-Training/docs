...
Once it gets connected, you can get the following capabilities:- **Product Discovery:** Enable natural language search to help users find products and receive personalized recommendations.
...
Once it gets connected, you can get the following capabilities:**Create Customer**: Creates a new customer record in Stripe.
...
By clicking on the Integrations, you will be able to see the MCP servers that were created.Click to add any tool. After that, you can modify the ** LLM description, Input variables, and Output variables.***![mceclip3(1).png](./images/mceclip31.png)
...
Go to **AI Pilots > Integrations (MCP)**. Use the search bar to find your MCP integration.Available actions:**Edit**: Modify any field.
