...
description: "In this article, we’ll discuss how **agents** function as dedicated modules that integrate effortlessly into a conversation flow. Agents are equipped ..."
---
...
*   [Steps to Create a New Agent](https://support.salesmate.io/hc/en-us/articles/46626362237721-How-to-Build-an-Agent#h_01JWEGQ37P557DAFDQGKAVNHTC)
*   [How to Configure an Agent](https://support.salesmate.io/hc/en-us/articles/46626362237721-How-to-Build-an-Agent#h_01JWTPD7VVAJQCK48KPC6G6SX5)
*   [Editing an Agent](https://support.salesmate.io/hc/en-us/articles/46626362237721-How-to-Build-an-Agent#h_01JWEGQ37R6NXY221WZW99GPHJ)
...
![Screen Shot 2025-06-09 at 4.45.08 PM.png](./How to Build an Agent – Salesmate_files/Screen Shot 2025-06-09 at 4.45.08 PM.png)
...
![Screen Shot 2025-06-10 at 5.23.44 PM.png](./How to Build an Agent – Salesmate_files/Screen Shot 2025-06-10 at 5.23.44 PM.png)
...
**[Paths](https://support.salesmate.io/hc/en-us/articles/46626606669593):** Paths define the conversational routes the agent follows based on different outputs or decisions.
...
**[Knowledge Base](https://support.salesmate.io/hc/en-us/articles/44390956989977) Access**
...
![Screen Shot 2025-06-10 at 5.26.44 PM.png](./How to Build an Agent – Salesmate_files/Screen Shot 2025-06-10 at 5.26.44 PM.png)

**[Prompt](https://support.salesmate.io/hc/en-us/articles/45878724921369) Settings**

*   **Access Prompt Settings:** Click the **“Settings”** button on the **“Create New Agent”** page to access prompt settings.
    
*   **AI Model:** Select the desired AI model for generating responses (e.g. **gpt-4.0** or **gpt-4.1**).
    
*   **Temperature:** Use this to adjust the creativity level of AI-generated responses.
    
    *   Use the slider to set the value between **0** (least creative) and **1** (most creative).
        
*   **Max Tokens:** This determines the length of each AI-generated response.
    
    *   Use the slider to adjust the value from **0 to 2000 characters**.
        

![Screen Shot 2025-06-10 at 5.28.13 PM.png](./How to Build an Agent – Salesmate_files/Screen Shot 2025-06-10 at 5.28.13 PM.png)
...
![Screen Shot 2025-06-10 at 5.29.07 PM.png](./How to Build an Agent – Salesmate_files/Screen Shot 2025-06-10 at 5.29.07 PM.png)