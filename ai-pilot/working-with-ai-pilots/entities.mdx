---
title: "Entities"
description: "**Entities** in Salesmate AI Pilots capture key information from user interactions, such as names, dates, numbers, or custom values, and work alongsid..."
---
...
*   [Entity Listing Screen](https://support.salesmate.io/hc/en-us/articles/45878663682841-Entities#h_01JVVWWWE57939NQ7BVWM0CDMK)
*   [How to Create an Entity](https://support.salesmate.io/hc/en-us/articles/45878663682841-Entities#h_01JVW3C2N86J3M37MWGYE5S5SQ)
    
*   [How to Edit an Entity](https://support.salesmate.io/hc/en-us/articles/45878663682841-Entities#h_01JVW42Y8FBS5YP9NF5XKVQW81)
    
*   [How to Delete an Entity](https://support.salesmate.io/hc/en-us/articles/45878663682841-Entities#h_01JVW436RJAVRV7FQE98WJNDJ1)
    
*   [Tips for Entity Management](https://support.salesmate.io/hc/en-us/articles/45878663682841-Entities#h_01JWG4G6JE1XE5QXF01PCA3TTP)

### Entity Listing Screen

*   Navigate to **AI Pilots** from the left menu bar.

![Screen Shot 2025-06-06 at 6.41.14 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.41.14 PM.png)
...
![Screen Shot 2025-06-06 at 6.49.12 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.49.12 PM.png)
...
![Screen Shot 2025-06-06 at 6.51.18 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.51.18 PM.png)
...
![Screen Shot 2025-06-06 at 6.54.14 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.54.14 PM.png)
...
![Screen Shot 2025-06-06 at 6.55.44 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.55.44 PM.png)
...
![Screen Shot 2025-06-06 at 6.56.43 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.56.43 PM.png)

*   You will have to click on the Confirmation Box in order to delete the Entity.
    

![Screen Shot 2025-06-06 at 6.57.29 PM.png](./Entities – Salesmate_files/Screen Shot 2025-06-06 at 6.57.29 PM.png)
...
*   **Define a clear purpose for each entity:** Each entity should capture only one specific type of data.  
    Example: Use flight\_date to capture the travel date instead of a vague travel\_info entity.
*   **Keep entities granular:** Break down data into smaller, useful parts for more accurate recognition.  
    Example: Use departure\_city and arrival\_city instead of a general city entity.
...
*   **Avoid overlapping or redundant entities:** Make sure each entity has a distinct and non-conflicting role.  
    Example: Use only arrival\_city instead of multiple similar entities like end\_city or final\_city.
