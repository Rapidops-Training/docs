...
Select the **AI Pilot** from the drop-down.Move to the \*\* Functions.\*\*\*<img src="./images/mceclip1-3.png" alt="mceclip1.png" />
...
- \*\* Thumbnail Image \*\*: Supports .png, .jpeg, .jpg under 1 MB.Appears in selection lists where this function is referenced.
