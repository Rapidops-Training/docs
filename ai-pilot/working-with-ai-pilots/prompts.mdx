...
- **For example:** If a prompt is created for “Flight Booking Inquiry” and a user says, “I want to book a flight to New York,” the AI Pilot identifies the intent and responds:
