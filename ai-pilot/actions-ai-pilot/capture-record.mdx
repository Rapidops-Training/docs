...
description: "The **Capture Record** action allows AI Agents to collect and store user input directly into either **Contact** or **Company** fields. ..."
---
...
*   [To configure the Capture Record Action](https://support.salesmate.io/hc/en-us/articles/45880137719833-Capture-Record#h_01JFB84RHPMPZ2NG0171X91QT9)
*   [Practical Example](https://support.salesmate.io/hc/en-us/articles/45880137719833-Capture-Record#h_01JWDSAE284Q7E3FTKTYCC0ER6)

### How to configure the Capture Record action

*   While setting up an Execution Flow, select the **Capture Record** action.

![](./Capture Record – Salesmate_files/mceclip0.png) Once the Capture Record action is selected, configure it by providing the following details:
...
![](./Capture Record – Salesmate_files/mceclip1.png)

*   Once the configuration is completed, hit **Save**.

### Practical Example

I’d like to capture basic information, such as name and email, from visitors who spend more than 10 seconds on the Contact Us page. Once we have their details, a team member will reach out to address any questions they may have. ![](./Capture Record – Salesmate_files/mceclip1(1).png)