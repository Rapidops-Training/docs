...
title: "Prompt\\"
---
You can use this action to run a trained AI prompt in your flow. The prompt can include system instructions, sample conversations, and variables to guide the response.
[Lean more](https://support.salesmate.io/hc/en-us/articles/45878724921369)
...
- **Only one prompt** can be selected.You can choose two** Output Options:**Capture to Variable** Save the response to a variable for use later in the flow.
