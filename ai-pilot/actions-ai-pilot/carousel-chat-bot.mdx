...
### Components of Carousel- **Name:** It is the identifier of the step.
...
Use the **Add Card button** to duplicate or create new cards.Additional Settings:- **No Match:** This triggers a fallback when the user's input doesn't match the button options. Sends reprompts and ends the flow if exhausted.
...
Additional Settings:- **No Match:** This triggers a fallback when the user's input doesn't match the button options. Sends reprompts and ends the flow if exhausted.
