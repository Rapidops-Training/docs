...
- **Move to **Voice settings.**![mceclip2.png](./images/mceclip2-2.png)
...
- **Talking Speed:** Adjusts the speed of the voice output to match user preference.
 Range: 0.7 (slowest) to 1.2 (fastest)Default: 1.0 (normal speed) - Visible only for models that support speed adjustment.
