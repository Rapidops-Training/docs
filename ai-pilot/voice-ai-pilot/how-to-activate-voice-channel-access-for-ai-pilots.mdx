...
<Note>
  **Note:** Before adding a phone number to AI Pilot, make sure you have purchased a phone number with Skara Voice & Text functionality.
</Note>
...
<img src="./images/mceclip4.png" alt="mceclip4.png" />

- Select the **Skara Voice \>\>**Hit **Install **
...
- Once it gets added, you can add numbers to AI Pilot.Click the three dots next to **Skara Voice.**
...
- You will see the list of channels here that are installed
- Click the three dots next to **Skara Voice.**
