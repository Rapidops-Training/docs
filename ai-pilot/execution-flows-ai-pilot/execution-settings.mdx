...
*   [How to Access Execution Settings](https://support.salesmate.io/hc/en-us/articles/45879809654553-Execution-Settings#h_01JWJXWWXHPMJ47VSZGNH763CZ)
*   [Execution Settings](https://support.salesmate.io/hc/en-us/articles/45879809654553-Execution-Settings#h_01JWJXWWXH1WHYAH0E2G6BMM0E)
*   [Best Practices](https://support.salesmate.io/hc/en-us/articles/45879809654553-Execution-Settings#01JWJZJW4WAHG1DVT173M8V51X)  
      
    

### How to Access Execution Settings

*   Navigate to **AI Pilots** from the main menu
*   Select your **AI Pilot**

![](./Execution Settings – Salesmate_files/mceclip1.png)

*   Click on **Execution Flows**
*   Choose or create a flow

![](./Execution Settings – Salesmate_files/mceclip2.png)

*   Open the **Execution Settings** panel in the canvas.

![](./Execution Settings – Salesmate_files/mceclip3.png)
...
![](./Execution Settings – Salesmate_files/mceclip4.png)

**Frequency:** Determine how frequently the flow should run when the trigger conditions are met:

*   **Only once**  
    The flow will run just a single time for a visitor/contact when conditions are matched.
*   **More than once**  
    The flow will run every time the conditions are met.
...
![](./Execution Settings – Salesmate_files/mceclip5.png)
...
*   *   **Run AI Pilot irrespective of user's availability: The** Flow will always run, even if users are offline.
    ...
    *   **Run only when everyone is unavailable to chat**  
        Flow runs only when no team members are available.
...
![](./Execution Settings – Salesmate_files/mceclip6.png)
...
*   Use **simple language** for flow names and descriptions.
*   Keep triggers and conditions aligned with your business goals.
*   Regularly review execution logs for optimization.
